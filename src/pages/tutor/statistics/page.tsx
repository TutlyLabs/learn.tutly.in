...
const TutorStats = ({mentors,mentees,data,currentUser,courseId,studentUsername,studentData,attendanceData,piechart,linechart,barchart,loaderValue}:any) => {
  return (
    <Providers>
        <Header
    ...
    />
    {
        ...
        <div className="m-4 flex flex-col gap-4 md:mx-8 md:gap-6 mt-6">
            ...
            <Card className="w-full rounded-xl p-4 shadow-xl shadow-blue-500/5 md:p-8 lg:w-1/4">
                ...
                <div className={`h-[10px] rounded-full bg-blue-500`} style={{ width: loaderValue }} />
                </div>
